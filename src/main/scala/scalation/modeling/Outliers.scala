 ...
 *  from the mean as an outlier.  Common number of standard deviation units are 2, 3 and 4.
 *  The larger the dataset, the greater the number of units that should be used.
 */
object DistanceOutlier extends Outlier:

    private val STDEV_CUTOFF = 2.0                                          // default stdev cutoff value
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** Detect outliers in the vector by treating anything that falls outside 5-th or
 *  95-th percentile.  Common percentiles that may be passed in factor are .01, .02 .05, .10, .15.
 */
object QuantileOutlier extends Outlier:

    private val PERCENTILE  = 0.05                                          // default percentile as fraction
 ...
 *  or above the 3rd Quartile as an Outlier.  Common values for X_MULTIPLIER are 1.5 to 3.0.
 */
object QuartileXOutlier extends Outlier:

    private val QUARTILE      = 0.25                                        // value for quartile as fraction
    private val X_MULTIPLIER  = 2.0                                         // default eXpansion multiplier
